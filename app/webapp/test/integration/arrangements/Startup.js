sap.ui.define([
	"sap/ui/test/Opa5",
	"sap/ui/demo/bookshop/Bookshop/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function(Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("sap.ui.demo.bookshop.Bookshop.test.integration.arrangements.Startup", {
		...
		iStartMyApp : function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "sap.ui.demo.bookshop.Bookshop",
					async: true
				},
				hash: oOptions.hash,
